export const environment = {
  ...
  auth: {
    ...
    auth0RedirectUri: 'http://sheldon0531.asuscomm.com/callback', // URL to return after auth0 login
    auth0ReturnTo: 'http://sheldon0531.asuscomm.com', // URL to return to after auth0 logout
